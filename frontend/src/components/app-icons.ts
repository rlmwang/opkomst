/**
 * The 23 icons the app draws, as one 24-by-24 stroked path set.
 *
 * A module rather than a component, because both the Vue ``AppIcon``
 * and the Svelte one draw them while the app crosses over
 * (``docs/tasks/svelte``), and one glyph should not have two
 * definitions. Adding an icon is a line in ``PATHS``; nothing else
 * knows the drawing.
 */
